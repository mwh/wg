...
astModule = BaseObject GraceDone $ fromList [
    ...
    , ("methodDecl(5)", \ctx [GraceString _, GraceAstList parts, GraceAstList rtype, GraceAstList anns, GraceAstList body] -> continuation ctx $ GraceAstObject (MethodDecl [n | GracePartObject n <- parts] [n | GraceAstObject n <- rtype] [n | GraceString n <- anns] [n | GraceAstObject n <- body]))
    ...
    , ("varDecl(5)", \ctx [GraceString _, GraceString name, GraceAstList rtype, GraceAstList anns, GraceAstList init] -> continuation ctx $ GraceAstObject (VarDecl name [n | GraceAstObject n <- rtype] [n | GraceString n <- anns] [n | GraceAstObject n <- init]))
    ...
    , ("defDecl(5)", \ctx [GraceString _, GraceString name, GraceAstList rtype, GraceAstList anns, GraceAstObject init] -> continuation ctx $ GraceAstObject (DefDecl name [n | GraceAstObject n <- rtype] [n | GraceString n <- anns] init))
