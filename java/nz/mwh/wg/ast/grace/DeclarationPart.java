...
public class DeclarationPart extends nz.mwh.wg.ast.DeclarationPart implements GraceObject {
    
    public DeclarationPart(String name, Cons<IdentifierDeclaration> parameters) {
